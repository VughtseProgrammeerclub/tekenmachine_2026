...
servoSchouderStart = 150
servoElleboogStart = 120
...
time.sleep(1)
oled_message("Test", "Schouder", "")
set_servo_angle(servo_schouder, servoSchouderStart - 5)
time.sleep(0.5)
set_servo_angle(servo_schouder, servoSchouderStart)
time.sleep(0.5)
set_servo_angle(servo_schouder, servoSchouderStart + 5)
...
oled_message("Test", "Elleboog", "")
set_servo_angle(servo_elleboog, servoElleboogStart - 5)
time.sleep(0.5)
set_servo_angle(servo_elleboog, servoElleboogStart)
time.sleep(0.5)
set_servo_angle(servo_elleboog, servoElleboogStart + 5)
...
oled_message("Test", "Pen", "")
set_servo_angle(servo_pen, 90 - 15)
time.sleep(0.5)
set_servo_angle(servo_pen, 90)
time.sleep(0.5)
set_servo_angle(servo_pen, 90 + 15)
